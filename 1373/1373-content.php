        ...
        <div class="slide-show">
            <div class="row">
                ...
                <div class="col-md-3" >
                    <div class="img1">
                        <a href="#">
                            <img src="../1311/images/3.png" alt="1" stt="1" class="img-responsive">
                        </a>                    
                    </div>
                    <div class="img-text">
                ...
                <div class="col-md-3 test" >
                    <div class="img1">
                        <a href="#">
                            <img src="../1311/images/6.png" alt="2" class="img-responsive">
                        </a>     
                    </div>
                    <div class="img-text">
                        <h4 class="name">
                ...
                <div class="col-md-3 test" >
                    <div class="img1">
                        <a href="#">
                            <img src="../1311/images/1.png" alt="3" class="img-responsive">
                        </a>                    
                    </div>
                    <div class="img-text">
                        <h4 class="name">
                ...
                <div class="col-md-3 test" >
                    <div class="img1">
                        <a href="#">
                            <img src="../1311/images/4.png" alt="4" class="img-responsive">
                        </a>                    
                    </div>
                    <div class="img-text">
                        <h4 class="name">
